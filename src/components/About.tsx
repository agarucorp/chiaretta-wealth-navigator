          ...
          <div className="block lg:hidden">
            ...
            <div className="text-left">
              ...
              <h3 className="mb-2 georgia-font" style={{ fontFamily: 'Georgia, "Times New Roman", Times, serif !important', fontWeight: 700, fontSize: '34px', color: '#1a237e' }}>
                I'm here to manage your finance with experience
              </h3>
            ...
            <div className="space-y-8">
              <p className="text-foreground/80 leading-relaxed text-left" style={{ fontSize: '15px', color: '#1a237e', fontFamily: 'Mulish, sans-serif' }}>
